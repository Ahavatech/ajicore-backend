...
const standardModules = [
  {
    ...
    routes: [
      ...
      { method: 'get', path: '/internal-api-token', handler: 'getInternalApiToken', query: { business_id: BUSINESS_ID }, invalidQuery: {}, failureAuth: 'requireAuth' },
  ...
  },
  {
    ...
    basePath: '/api/staff',
    controllerModules: [{ modulePath: 'src/domains/team/staff.controller.js', handlers: ['getAllStaff', 'calculatePayroll', 'getTimesheets', 'getStaffById', 'createStaff', 'updateStaff', 'deleteStaff', 'clockIn', 'clockOut'] }],
    routes: [
