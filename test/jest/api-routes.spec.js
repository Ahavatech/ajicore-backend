...
const standardModules = [
  ...
  },
  {
    ...
    routes: [
      ...
      { method: 'get', path: `/${VALID_UUID}/billing`, handler: 'getBilling', invalidPath: '/bad-uuid/billing', failureAuth: 'requireAuth' },
      { method: 'get', path: `/${VALID_UUID}/schedule`, handler: 'getSchedule', invalidPath: '/bad-uuid/schedule', failureAuth: 'requireAuth' },
  ...
  },
  {
    ...
    basePath: '/api/quotes',
    controllerModules: [{ modulePath: 'src/domains/quotes/quote.controller.js', handlers: ['getAll', 'getById', 'create', 'update', 'sendQuote', 'approve', 'convert', 'decline', 'remove'] }],
    routes: [
      { method: 'get', path: '/', handler: 'getAll', query: { business_id: BUSINESS_ID }, invalidQuery: {}, failureAuth: 'requireAuth' },
      { method: 'get', path: `/${VALID_UUID}`, handler: 'getById', invalidPath: '/bad-uuid', failureAuth: 'requireAuth' },
  ...
  },
  {
    ...
    basePath: '/api/staff',
    controllerModules: [{ modulePath: 'src/domains/team/staff.controller.js', handlers: ['getAllStaff', 'getAvailableStaff', 'getStaffMetrics', 'calculatePayroll', 'getTimesheets', 'getStaffTimesheets', 'getStaffPayroll', 'getStaffById', 'createStaff', 'updateStaff', 'deleteStaff', 'clockIn', 'clockOut'] }],
    routes: [
