...
const standardModules = [
  ...
  },
  {
    ...
    controllerModules: [{ modulePath: 'src/domains/customers/customer.controller.js', handlers: ['getAll', 'getMetrics', 'findByPhone', 'getById', 'getHistory', 'create', 'update', 'remove'] }],
    routes: [
